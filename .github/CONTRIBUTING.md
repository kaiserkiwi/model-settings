...
### AI / "Vibe" generated Pull Requests
Pull requests that are fully generated by an AI or merely "vibe coded" (uncritically copied, not properly understood, and not executed or tested locally AI output) will not be accepted. Every contribution must be demonstrably reviewed, run, tested, and manually refined where needed. Submit only changes you fully understand and whose quality you personally stand behind.
